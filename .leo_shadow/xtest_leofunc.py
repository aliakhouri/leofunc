#@+leo-ver=4-thin
#@+node:sa.20090403012613.2:@shadow test_leofunc.py
#@@language python
#@@tabwidth -4
#@+others
#@+node:sa.20090403012706.51:test_leofunc declarations
#!/usr/bin/env python
from leofunc import Node, To, PATTERNS
...
#@-node:sa.20090403012706.51:test_leofunc declarations
#@+node:sa.20090403012706.79:utility functions
#@+node:sa.20090412220044.2:register
def register(node=None, match_head=None, match_body=None):
    ...
    return _register
#@-node:sa.20090412220044.2:register
#@+node:sa.20090403012706.52:headline
...
def headline(text, top=True, bottom=True, sep='-'):
    ...
    if bottom:
        print sep * 70
#@-node:sa.20090403012706.52:headline
#@+node:sa.20090403012706.53:display
...
def display(root):
    ...
    for i in root:
        print i
#@-node:sa.20090403012706.53:display
#@+node:sa.20090403222930.5:node1
...
#@-node:sa.20090403222930.5:node1
#@+node:sa.20090403012706.55:get_tree
...
#@-node:sa.20090403012706.55:get_tree
#@+node:sa.20090403222930.2:match
...
#@-node:sa.20090403222930.2:match
#@+node:sa.20090412001020.1:standard
...
#@-node:sa.20090412001020.1:standard
#@-node:sa.20090403012706.79:utility functions
#@+node:sa.20090408102856.10:directives
# TESTING Directives
# ---------------------------------------------------

#@+node:sa.20090412215832.1:test_signature
@register()
def test_signature():
    ...
    for d in directives:
        test(d)
#@-node:sa.20090412215832.1:test_signature
#@+node:sa.20090403194916.1:py
#@+node:sa.20090403012706.56:test_py_expr_1
...
#@-node:sa.20090403012706.56:test_py_expr_1
#@+node:sa.20090410130211.1:test_py_expr_2
py_expr_2 = node1(
    "@pyc y = 1", 
    "@py y * 32"
)
...
def test_py_expr_2():
    ...
    # display(n)
#@-node:sa.20090410130211.1:test_py_expr_2
#@+node:sa.20090410130211.3:test_py_expr_3
...
def test_py_expr_3():
    ...
    display(n)
#@-node:sa.20090410130211.3:test_py_expr_3
#@+node:sa.20090410130211.2:test_py_expr_4
...
#@-node:sa.20090410130211.2:test_py_expr_4
#@-node:sa.20090403194916.1:py
#@+node:sa.20090403194916.2:pyc
#@+node:sa.20090403012706.57:test_py_suite_1
...
#@-node:sa.20090403012706.57:test_py_suite_1
#@+node:sa.20090403012706.58:test_py_suite_2
py_suite_2 = node1(
...
#@-node:sa.20090403012706.58:test_py_suite_2
#@-node:sa.20090403194916.2:pyc
#@+node:sa.20090403194916.3:pipe
#@+node:sa.20090403012706.59:test_pipe_1
pipe_1 = node1(
    "@pipe 'd' | upper",
    "this is a body"
)
...
#@-node:sa.20090403012706.59:test_pipe_1
#@+node:sa.20090403012706.60:test_pipe_2
pipe_2 = node1(
...
#@-node:sa.20090403012706.60:test_pipe_2
#@+node:sa.20090403012706.61:test_pipe_3
pipe_3 = node1(
...
#@-node:sa.20090403012706.61:test_pipe_3
#@+node:sa.20090403183032.2:test_pipe_4
pipe_4 = Node(
...
#@-node:sa.20090403183032.2:test_pipe_4
#@+node:sa.20090412001020.2:test_pipe_5
pipe_5 = node1(
...
#@-node:sa.20090412001020.2:test_pipe_5
#@-node:sa.20090403194916.3:pipe
#@+node:sa.20090411210049.1:shell
#@+node:sa.20090411210049.5:test_shell_1
shell_1 = node1(
    "@shell rm *.pyc",
    "@sh ls -l"
)
...
#@-node:sa.20090411210049.5:test_shell_1
#@+node:sa.20090412220044.3:test_shell_2
...
#@-node:sa.20090412220044.3:test_shell_2
#@-node:sa.20090411210049.1:shell
#@+node:sa.20090403194916.4:imports
#@+node:sa.20090403012706.63:test_imports
imports_1 = node1(
    "a basic headline", 
    """
    @imports
...
#@-node:sa.20090403012706.63:test_imports
#@+node:sa.20090403012706.64:test_complex_imports
imports_2 = node1(
    "a basic headline", 
    """
    @imports
...
#@-node:sa.20090403012706.64:test_complex_imports
#@-node:sa.20090403194916.4:imports
#@+node:sa.20090403194916.5:sort
#@+node:sa.20090403012706.65:test_sorting_levels
@register()
...
#@-node:sa.20090403012706.65:test_sorting_levels
#@+node:sa.20090403020606.1:test_sort_directive
@register()
...
#@-node:sa.20090403020606.1:test_sort_directive
#@-node:sa.20090403194916.5:sort
#@+node:sa.20090403194916.6:templating
#@+node:sa.20090403012706.66:test_template
tmpl_1 = node1(
...
#@-node:sa.20090403012706.66:test_template
#@+node:sa.20090403012706.67:test_cheetah
cheetah_1 = node1(
...
#@-node:sa.20090403012706.67:test_cheetah
#@-node:sa.20090403194916.6:templating
#@+node:sa.20090408100102.2:parameters
#@+node:sa.20090408100102.3:test_param_1
@register()
def test_param_1():
...
#@nonl
#@-node:sa.20090408100102.3:test_param_1
#@+node:sa.20090408100102.4:test_param_2
...
def test_param_2():
    ...
    display(n)
#@-node:sa.20090408100102.4:test_param_2
#@+node:sa.20090408100102.5:test_param_3
...
def test_param_3():
    ...
    display(n)
#@-node:sa.20090408100102.5:test_param_3
#@+node:sa.20090408100102.6:test_param_4
...
def test_param_4():
    ...
    display(n)
#@-node:sa.20090408100102.6:test_param_4
#@+node:sa.20090408100102.7:test_param_5
...
def test_param_5():
    ...
    display(n)
#@-node:sa.20090408100102.7:test_param_5
#@+node:sa.20090408102856.12:test_param_6
...
#@-node:sa.20090408102856.12:test_param_6
#@-node:sa.20090408100102.2:parameters
#@+node:sa.20090408102856.11:class instance
#@+node:sa.20090408100102.9:test_person
...
#@-node:sa.20090408100102.9:test_person
#@-node:sa.20090408102856.11:class instance
#@+node:sa.20090411175828.7:tree functions
#@+node:sa.20090411175828.6:test_csum_1
@register()
def test_csum_1():
...
#@-node:sa.20090411175828.6:test_csum_1
#@+node:sa.20090411210049.14:test_csum_2
@register()
def test_csum_2():
...
#@-node:sa.20090411175828.7:tree functions
#@-node:sa.20090408102856.10:directives
#@+node:sa.20090403194916.7:misc
#@+node:sa.20090403012706.70:test_del_view
@register()
def test_del_view():
    root = tree1
    root.head.view = 'ok'
...
#@-node:sa.20090403012706.70:test_del_view
#@+node:sa.20090403012706.68:test_tree1
...
#@-node:sa.20090403012706.68:test_tree1
#@+node:sa.20090403012706.69:test_redirectors
@register()
...
#@-node:sa.20090403012706.69:test_redirectors
#@+node:sa.20090403012706.73:test_pattern_1
@register()
def test_pattern_1():
...
#@-node:sa.20090403012706.73:test_pattern_1
#@+node:sa.20090408100102.8:test_dot
dot_1 = node1(
    "@graph a -> b",
    """
    @graph
...
def test_dot():
    ...
    display(n)
#@-node:sa.20090408100102.8:test_dot
#@+node:sa.20090408102856.6:test_rss
...
#@-node:sa.20090408102856.6:test_rss
#@+node:sa.20090414220332.1:test_doc
doc_1 = node1(
    "@doc I like this",
    """
    @doc
...
#@-node:sa.20090414220332.1:test_doc
#@+node:sa.20090414220332.2:test_shadow
...
#@-node:sa.20090414220332.2:test_shadow
#@-node:sa.20090403194916.7:misc
#@+node:sa.20090408100102.10:_test
def _test():
    for t in TESTS:
        print
